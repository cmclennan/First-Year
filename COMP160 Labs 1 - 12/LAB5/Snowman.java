...
public class Snowman extends JFrame{
  ...
  public void paint (Graphics page)
  {
    ...
    page.drawString("Cameron", 5, 35); // String (my name) and placement
    ...
    page.fillOval(MID + 0, TOP + 40, 10, 10); //top button
    page.fillOval(MID + 0, TOP + 55, 10, 10); // bottom button
    
    page.setColor (Color.black);
    page.fillOval (MID - 10, TOP + 10, 5, 5);   // left eye
    page.fillOval (MID + 5, TOP + 10, 5, 5);    // right eye
    
    page.drawArc (MID - 10, TOP + 25, 20, 10, 50, 80);   // smile
